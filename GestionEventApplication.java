...
public class GestionEventApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Prestataire p1 = prestataireService.createPrestataire("DIOP", "May", "Restauratrice", "123",
				"diop@gmail.com",
				null);
		...
		Prestataire p2 = prestataireService.createPrestataire("SOUARE", "KEBA", "Receptrice", "123",
				"keba@gmail.com",
				null);
		Prestataire p3 = prestataireService.createPrestataire("naruto", "boruto", "Restaurateur", "123",
				"nagato@gmail.com",
				null);
		...
		Evenement ev4 = new Evenement("Gamou", new Date(),
				"Il s'agit de célébrer la naissance du prophète Seydina Mohamed.", "Madina Baye", c2);
